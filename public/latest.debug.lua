...
\9local searchFocused = _binding_1[1]\
\9local setSearchFocused = _binding_1[2]\
\9useEffect(function()\
...
", '@'.."Havoc.components.Acrylic.Acrylic.story")) setfenv(fn, newEnv("Havoc.components.Acrylic.Acrylic.story")) return fn() end)
...
newModule("TextBoxWithDropdown", "ModuleScript", "Havoc.components.TextBoxWithDropdown", "Havoc.components", function () local fn = assert(loadstring("-- Compiled with roblox-ts v1.2.7\
local TS = require(script.Parent.Parent.include.RuntimeLib)\
local Roact = TS.import(script, TS.getModule(script, \"@rbxts\", \"roact\").src)\
local _roact_hooked = TS.import(script, TS.getModule(script, \"@rbxts\", \"roact-hooked\").out)\
local hooked = _roact_hooked.hooked\
...
\9local _binding = useState(false)\
\9local focused = _binding[1]\
\9local setFocused = _binding[2]\
\9local dropdownVisible = focused and (options and #options or 0) > 0\
...
\9local _length = #_children\
\9if _condition then\
\9\9if _condition.elements ~= nil or _condition.props ~= nil and _condition.component ~= nil then\
\9\9\9_children[_length + 1] = _condition\
\9\9else\
\9\9\9for _k, _v in ipairs(_condition) do\
\9\9\9\9_children[_length + _k] = _v\
\9\9\9end\
\9\9end\
\9end\
...
", '@'.."Havoc.components.TextBoxWithDropdown")) setfenv(fn, newEnv("Havoc.components.TextBoxWithDropdown")) return fn() end)
...
\9end\
\9Workspace.Gravity = enabled and DEFAULT_GRAVITY or 0\
end\
...
\9\9setStore(store)\
\9\9local host = IS_DEV and (Players.LocalPlayer:WaitForChild(\"PlayerGui\")) or (game:GetService(\"CoreGui\"))\
\9\9local container = Make(\"Folder\", {\
\9\9\9Name = \"HavocMount\",\
\9\9\9Parent = host,\
\9\9})\
\9\9Roact.mount(Roact.createElement(Provider, {\
\9\9\9store = store,\
\9\9}, {\
...
\9\9end\
\9\9local synObj = syn\
\9\9local _result = synObj\
\9\9if _result ~= nil then\
\9\9\9_result = _result.protect_gui\
\9\9end\
\9\9if _result then\
\9\9\9pcall(function()\
\9\9\9\9return synObj.protect_gui(app)\
\9\9\9end)\
\9\9end\
...
newModule("misc.action", "ModuleScript", "Havoc.store.actions.misc.action", "Havoc.store.actions", function () local fn = assert(loadstring("-- Compiled with roblox-ts v1.2.7\
local TS = require(script.Parent.Parent.Parent.include.RuntimeLib)\
local Rodux = TS.import(script, TS.getModule(script, \"@rbxts\", \"rodux\").src)\
...
", '@'.."Havoc.store.actions.misc.action")) setfenv(fn, newEnv("Havoc.store.actions.misc.action")) return fn() end)
...
newModule("misc.model", "ModuleScript", "Havoc.store.models.misc.model", "Havoc.store.models", function () local fn = assert(loadstring("-- Compiled with roblox-ts v1.2.7\
...
", '@'.."Havoc.store.models.misc.model")) setfenv(fn, newEnv("Havoc.store.models.misc.model")) return fn() end)
...
", '@'.."Havoc.views.Dashboard.Dashboard.story")) setfenv(fn, newEnv("Havoc.views.Dashboard.Dashboard.story")) return fn() end)
...
", '@'.."Havoc.views.Navbar.Navbar.story")) setfenv(fn, newEnv("Havoc.views.Navbar.Navbar.story")) return fn() end)
...
\9end\
\9local sliders = _result\
\9local _binding = useState(\"Z\")\
\9local keybind = _binding[1]\
\9local setKeybind = _binding[2]\
\9local _binding_1 = useState(false)\
\9local listeningForKey = _binding_1[1]\
\9local setListeningForKey = _binding_1[2]\
...
\9\9\9\9Text = job.active and \"Running\" or \"Press keybind to start\",\
...
\9\9\9Text = job.active and \"STOP\" or \"START\",\
...
\9\9\9\9Text = listeningForKey and \"...\" or keybind,\
...
\9\9\9\9\9\9\9local _condition = inp.KeyCode.Name\
\9\9\9\9\9\9\9if _condition == nil then\
\9\9\9\9\9\9\9\9_condition = \"Z\"\
\9\9\9\9\9\9\9end\
\9\9\9\9\9\9\9setKeybind(_condition)\
...
\9}\
\9local _binding = useState(\"\")\
\9local gistUrl = _binding[1]\
\9local setGistUrl = _binding[2]\
\9local _binding_1 = useState({})\
\9local gistList = _binding_1[1]\
\9local setGistList = _binding_1[2]\
\9local _binding_2 = useState(nil)\
\9local selectedGist = _binding_2[1]\
\9local setSelectedGist = _binding_2[2]\
...
\9\9\9\9BackgroundColor3 = isHovered and theme.button.background:Lerp(Color3.new(1, 1, 1), 0.05) or theme.button.background,\
\9\9\9\9TextColor3 = theme.button.foreground,\
\9\9\9\9Font = Enum.Font.GothamBold,\
\9\9\9\9TextSize = 16,\
\9\9\9\9AutoButtonColor = false,\
...
\9\9\9\9\9Transparency = isHovered and 0.2 or 0.6,\
\9\9\9\9}),\
\9\9\9}),\
...
\
return Object\
", '@'.."Havoc.include.node_modules.object-utils")) setfenv(fn, newEnv("Havoc.include.node_modules.object-utils")) return fn() end)
...
exports.pure = pure\
return exports\
", '@'.."Havoc.include.node_modules.roact-hooked.out")) setfenv(fn, newEnv("Havoc.include.node_modules.roact-hooked.out")) return fn() end)
...
return exports\
", '@'.."Havoc.include.node_modules.roact-hooked.out.hooks")) setfenv(fn, newEnv("Havoc.include.node_modules.roact-hooked.out.hooks")) return fn() end)
...
-- Hooks\
return nil\
", '@'.."Havoc.include.node_modules.roact-hooked.out.types")) setfenv(fn, newEnv("Havoc.include.node_modules.roact-hooked.out.types")) return fn() end)
...
return exports\
", '@'.."Havoc.include.node_modules.roact-hooked.out.with-hooks")) setfenv(fn, newEnv("Havoc.include.node_modules.roact-hooked.out.with-hooks")) return fn() end)
...
return exports\
", '@'.."Havoc.include.node_modules.roact-rodux-hooked.out")) setfenv(fn, newEnv("Havoc.include.node_modules.roact-rodux-hooked.out")) return fn() end)
...
return nil\
", '@'.."Havoc.include.node_modules.roact-rodux-hooked.out.types")) setfenv(fn, newEnv("Havoc.include.node_modules.roact-rodux-hooked.out.types")) return fn() end)
