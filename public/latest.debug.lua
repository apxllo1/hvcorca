-- Havoc | Auto-generated by ci/bundle.lua — do not edit
...
return hInit, hMod, hInst, hEnv
    ...
    hMod("App", "ModuleScript", "Havoc.App", "Havoc", function()
        return _setfenv(assert(loadstring([[-- Compiled with roblox-ts v1.2.7
...
]])), hEnv("Havoc.components.Acrylic.Acrylic"))()
    end)
...
]])), hEnv("Havoc.components.Acrylic.Acrylic.story"))()
    end)
...
]])), hEnv("Havoc.components.Acrylic.acrylic-instance"))()
    end)
...
]])), hEnv("Havoc.components.ActionButton"))()
    end)
...
]])), hEnv("Havoc.components.BrightButton"))()
    end)
...
]])), hEnv("Havoc.components.BrightSlider"))()
    end)
...
]])), hEnv("Havoc.components.ParallaxImage"))()
    end)
...
]])), hEnv("Havoc.context.scale-context"))()
    end)
...
return exports
]])), hEnv("Havoc.hooks.common.flipper-hooks"))()
    end)
...
]])), hEnv("Havoc.hooks.common.flipper-hooks.get-binding"))()
    end)
...
]])), hEnv("Havoc.hooks.common.flipper-hooks.use-goal"))()
    end)
...
]])), hEnv("Havoc.hooks.common.flipper-hooks.use-instant"))()
    end)
...
]])), hEnv("Havoc.hooks.common.flipper-hooks.use-linear"))()
    end)
...
]])), hEnv("Havoc.hooks.common.flipper-hooks.use-motor"))()
    end)
...
]])), hEnv("Havoc.hooks.common.flipper-hooks.use-spring"))()
    end)
...
]])), hEnv("Havoc.hooks.common.rodux-hooks"))()
    end)
...
]])), hEnv("Havoc.hooks.common.use-delayed-update"))()
    end)
...
]])), hEnv("Havoc.hooks.common.use-did-mount"))()
    end)
...
]])), hEnv("Havoc.hooks.common.use-forced-update"))()
    end)
...
]])), hEnv("Havoc.hooks.common.use-interval"))()
    end)
...
]])), hEnv("Havoc.hooks.common.use-mouse-location"))()
    end)
...
]])), hEnv("Havoc.hooks.common.use-promise"))()
    end)
...
]])), hEnv("Havoc.hooks.common.use-set-state"))()
    end)
...
]])), hEnv("Havoc.hooks.common.use-spring"))()
    end)
...
]])), hEnv("Havoc.hooks.common.use-viewport-size"))()
    end)
...
]])), hEnv("Havoc.hooks.use-current-page"))()
    end)
...
]])), hEnv("Havoc.hooks.use-parallax-offset"))()
    end)
...
return nil
]])), hEnv("Havoc.jobs.character.flight"))()
    end)
...
return nil
]])), hEnv("Havoc.jobs.character.ghost"))()
    end)
...
return nil
]])), hEnv("Havoc.jobs.character.godmode"))()
    end)
...
return nil
]])), hEnv("Havoc.jobs.character.humanoid"))()
    end)
...
return nil
]])), hEnv("Havoc.jobs.character.refresh"))()
    end)
...
return nil
    ...
    hMod("freecam", "ModuleScript", "Havoc.jobs.helpers.freecam", "Havoc.jobs.helpers", function()
        return _setfenv(assert(loadstring([[------------------------------------------------------------------------
-- Freecam
...
]])), hEnv("Havoc.jobs.helpers.freecam"))()
    end)
...
]])), hEnv("Havoc.jobs.helpers.get-selected-player"))()
    end)
...
]])), hEnv("Havoc.jobs.helpers.job-store"))()
    end)
...
return nil
]])), hEnv("Havoc.jobs.players.facebang"))()
    end)
...
return nil
]])), hEnv("Havoc.jobs.players.spectate"))()
    end)
...
return nil
]])), hEnv("Havoc.jobs.players.teleport"))()
    end)
...
]])), hEnv("Havoc.store.actions.dashboard.action"))()
    end)
...
]])), hEnv("Havoc.store.actions.jobs.action"))()
    end)
...
]])), hEnv("Havoc.store.actions.options.action"))()
    end)
...
]])), hEnv("Havoc.store.models.options.model"))()
    end)
...
]])), hEnv("Havoc.store.persistent-state"))()
    end)
...
]])), hEnv("Havoc.store.reducers.dashboard.reducer"))()
    end)
...
]])), hEnv("Havoc.store.reducers.jobs.reducer"))()
    end)
...
]])), hEnv("Havoc.store.reducers.options.reducer"))()
    end)
...
]])), hEnv("Havoc.themes.frosted-glass"))()
    end)
...
]])), hEnv("Havoc.themes.high-contrast"))()
    end)
...
]])), hEnv("Havoc.views.Dashboard.Dashboard"))()
    end)
...
]])), hEnv("Havoc.views.Dashboard.Dashboard.story"))()
    end)
...
]])), hEnv("Havoc.views.Navbar.Navbar"))()
    end)
...
]])), hEnv("Havoc.views.Navbar.Navbar.story"))()
    end)
...
]])), hEnv("Havoc.views.Navbar.NavbarTab"))()
    end)
...
]])), hEnv("Havoc.views.Pages.Apps.Apps"))()
    end)
...
return exports
]])), hEnv("Havoc.views.Pages.Apps.Players"))()
    end)
...
]])), hEnv("Havoc.views.Pages.Apps.Players.Actions"))()
    end)
...
]])), hEnv("Havoc.views.Pages.Apps.Players.Avatar"))()
    end)
...
]])), hEnv("Havoc.views.Pages.Apps.Players.Players"))()
    end)
...
]])), hEnv("Havoc.views.Pages.Apps.Players.Selection"))()
    end)
...
]])), hEnv("Havoc.views.Pages.Apps.Players.Username"))()
    end)
...
return exports
]])), hEnv("Havoc.views.Pages.Home.FriendActivity"))()
    end)
...
]])), hEnv("Havoc.views.Pages.Home.FriendActivity.FriendActivity"))()
    end)
...
]])), hEnv("Havoc.views.Pages.Home.FriendActivity.FriendItem"))()
    end)
...
]])), hEnv("Havoc.views.Pages.Home.FriendActivity.GameItem"))()
    end)
...
]])), hEnv("Havoc.views.Pages.Home.Home"))()
    end)
...
return exports
]])), hEnv("Havoc.views.Pages.Home.Profile"))()
    end)
...
]])), hEnv("Havoc.views.Pages.Home.Profile.Actions"))()
    end)
...
]])), hEnv("Havoc.views.Pages.Home.Profile.Avatar"))()
    end)
...
]])), hEnv("Havoc.views.Pages.Home.Profile.Info"))()
    end)
...
]])), hEnv("Havoc.views.Pages.Home.Profile.Profile"))()
    end)
...
]])), hEnv("Havoc.views.Pages.Home.Profile.Sliders"))()
    end)
...
]])), hEnv("Havoc.views.Pages.Home.Profile.Username"))()
    end)
...
return exports
]])), hEnv("Havoc.views.Pages.Home.Server"))()
    end)
...
]])), hEnv("Havoc.views.Pages.Home.Server.Server"))()
    end)
...
]])), hEnv("Havoc.views.Pages.Home.Server.ServerAction"))()
    end)
...
]])), hEnv("Havoc.views.Pages.Home.Server.StatusLabel"))()
    end)
...
]])), hEnv("Havoc.views.Pages.Home.Title"))()
    end)
...
]])), hEnv("Havoc.views.Pages.Misc.FacebangModal"))()
    end)
...
]])), hEnv("Havoc.views.Pages.Misc.Misc"))()
    end)
...
return exports
]])), hEnv("Havoc.views.Pages.Options"))()
    end)
...
return exports
]])), hEnv("Havoc.views.Pages.Options.Config"))()
    end)
...
]])), hEnv("Havoc.views.Pages.Options.Config.Config"))()
    end)
...
]])), hEnv("Havoc.views.Pages.Options.Config.ConfigItem"))()
    end)
...
]])), hEnv("Havoc.views.Pages.Options.Options"))()
    end)
...
return exports
]])), hEnv("Havoc.views.Pages.Options.Shortcuts"))()
    end)
...
]])), hEnv("Havoc.views.Pages.Options.Shortcuts.ShortcutItem"))()
    end)
...
]])), hEnv("Havoc.views.Pages.Options.Shortcuts.Shortcuts"))()
    end)
...
return exports
]])), hEnv("Havoc.views.Pages.Options.Themes"))()
    end)
...
]])), hEnv("Havoc.views.Pages.Options.Themes.ThemeItem"))()
    end)
...
]])), hEnv("Havoc.views.Pages.Options.Themes.Themes"))()
    end)
...
return exports
]])), hEnv("Havoc.views.Pages.Scripts"))()
    end)
...
]])), hEnv("Havoc.views.Pages.Scripts.Content"))()
    end)
...
]])), hEnv("Havoc.views.Pages.Scripts.ScriptCard"))()
    end)
...
]])), hEnv("Havoc.views.Pages.Scripts.Scripts"))()
    end)
...
]])), hEnv("Havoc.views.Pages.Scripts.constants"))()
    end)
...
return Promise
]=])), hEnv("Havoc.include.Promise"))()
    end)
    hMod("RuntimeLib", "ModuleScript", "Havoc.include.RuntimeLib", "Havoc.include", function()
        return _setfenv(assert(loadstring([[local Promise = require(script.Parent.Promise)
...
return TS
    ...
    hMod("src", "ModuleScript", "Havoc.include.node_modules.flipper.src", "Havoc.include.node_modules.flipper", function()
        return _setfenv(assert(loadstring([[local Flipper = {
...
return Flipper]])), hEnv("Havoc.include.node_modules.flipper.src"))()
    end)
    ...
    hMod("make", "ModuleScript", "Havoc.include.node_modules.make", "Havoc.include.node_modules", function()
        return _setfenv(assert(loadstring([=[-- Compiled with roblox-ts v1.2.3
--[[
	*
...
return Make
]=])), hEnv("Havoc.include.node_modules.make"))()
    end)
    ...
    hMod("object-utils", "ModuleScript", "Havoc.include.node_modules.object-utils", "Havoc.include.node_modules", function()
        return _setfenv(assert(loadstring([=[local HttpService = game:GetService("HttpService")
...
return Object
]=])), hEnv("Havoc.include.node_modules.object-utils"))()
    end)
...
return Roact]=])), hEnv("Havoc.include.node_modules.roact.src"))()
    end)
...
exports.pure = pure
return exports
]=])), hEnv("Havoc.include.node_modules.roact-hooked.out"))()
    end)
...
return exports
]])), hEnv("Havoc.include.node_modules.roact-hooked.out.hooks"))()
    end)
...
]=])), hEnv("Havoc.include.node_modules.roact-hooked.out.hooks.use-binding"))()
    end)
...
]=])), hEnv("Havoc.include.node_modules.roact-hooked.out.hooks.use-callback"))()
    end)
...
]=])), hEnv("Havoc.include.node_modules.roact-hooked.out.hooks.use-context"))()
    end)
...
]=])), hEnv("Havoc.include.node_modules.roact-hooked.out.hooks.use-effect"))()
    end)
...
]=])), hEnv("Havoc.include.node_modules.roact-hooked.out.hooks.use-memo"))()
    end)
...
]=])), hEnv("Havoc.include.node_modules.roact-hooked.out.hooks.use-mutable"))()
    end)
...
]=])), hEnv("Havoc.include.node_modules.roact-hooked.out.hooks.use-reducer"))()
    end)
...
]=])), hEnv("Havoc.include.node_modules.roact-hooked.out.hooks.use-ref"))()
    end)
...
]=])), hEnv("Havoc.include.node_modules.roact-hooked.out.hooks.use-state"))()
    end)
...
-- Hooks
return nil
]])), hEnv("Havoc.include.node_modules.roact-hooked.out.types"))()
    end)
...
]])), hEnv("Havoc.include.node_modules.roact-hooked.out.utils.are-deps-equal"))()
    end)
...
]=])), hEnv("Havoc.include.node_modules.roact-hooked.out.utils.memoized-hook"))()
    end)
...
return exports
]])), hEnv("Havoc.include.node_modules.roact-hooked.out.with-hooks"))()
    end)
...
]])), hEnv("Havoc.include.node_modules.roact-hooked.out.with-hooks.component-with-hooks"))()
    end)
...
]])), hEnv("Havoc.include.node_modules.roact-hooked.out.with-hooks.with-hooks"))()
    end)
...
return exports
]])), hEnv("Havoc.include.node_modules.roact-rodux-hooked.out"))()
    end)
...
]])), hEnv("Havoc.include.node_modules.roact-rodux-hooked.out.components.context"))()
    end)
...
]=])), hEnv("Havoc.include.node_modules.roact-rodux-hooked.out.components.provider"))()
    end)
...
]=])), hEnv("Havoc.include.node_modules.roact-rodux-hooked.out.helpers.shallow-equal"))()
    end)
...
]=])), hEnv("Havoc.include.node_modules.roact-rodux-hooked.out.hooks.use-dispatch"))()
    end)
...
]=])), hEnv("Havoc.include.node_modules.roact-rodux-hooked.out.hooks.use-selector"))()
    end)
...
]=])), hEnv("Havoc.include.node_modules.roact-rodux-hooked.out.hooks.use-store"))()
    end)
...
return nil
]=])), hEnv("Havoc.include.node_modules.roact-rodux-hooked.out.types"))()
    end)
    ...
    hMod("src", "ModuleScript", "Havoc.include.node_modules.rodux.src", "Havoc.include.node_modules.rodux", function()
        return _setfenv(assert(loadstring([[local Store = require(script.Store)
...
]])), hEnv("Havoc.include.node_modules.services"))()
    end)
