...
local fn = assert(loadstring("-- Compiled with roblox-ts v1.2.7\
...
return exports\
", '@'.."Havoc.components.Acrylic"))
setfenv(fn, newEnv("Havoc.components.Acrylic"))
return fn()
end)
...
", '@'.."Havoc.components.Acrylic.Acrylic"))
setfenv(fn, newEnv("Havoc.components.Acrylic.Acrylic"))
return fn()
end)
...
", '@'.."Havoc.components.Acrylic.Acrylic.story"))
setfenv(fn, newEnv("Havoc.components.Acrylic.Acrylic.story"))
return fn()
end)
...
", '@'.."Havoc.components.Acrylic.acrylic-instance"))
setfenv(fn, newEnv("Havoc.components.Acrylic.acrylic-instance"))
return fn()
end)
...
", '@'.."Havoc.components.ActionButton"))
setfenv(fn, newEnv("Havoc.components.ActionButton"))
return fn()
end)
...
", '@'.."Havoc.components.Border"))
setfenv(fn, newEnv("Havoc.components.Border"))
return fn()
end)
...
", '@'.."Havoc.components.BrightButton"))
setfenv(fn, newEnv("Havoc.components.BrightButton"))
return fn()
end)
...
", '@'.."Havoc.components.BrightSlider"))
setfenv(fn, newEnv("Havoc.components.BrightSlider"))
return fn()
end)
...
", '@'.."Havoc.components.Canvas"))
setfenv(fn, newEnv("Havoc.components.Canvas"))
return fn()
end)
...
setfenv(fn, newEnv("Havoc.components.Card"))
return fn()
end)
...
", '@'.."Havoc.components.Fill"))
setfenv(fn, newEnv("Havoc.components.Fill"))
return fn()
end)
...
", '@'.."Havoc.components.Glow"))
setfenv(fn, newEnv("Havoc.components.Glow"))
return fn()
end)
...
", '@'.."Havoc.components.ParallaxImage"))
setfenv(fn, newEnv("Havoc.components.ParallaxImage"))
return fn()
end)
...
", '@'.."Havoc.constants"))
setfenv(fn, newEnv("Havoc.constants"))
return fn()
end)
...
", '@'.."Havoc.context.scale-context"))
setfenv(fn, newEnv("Havoc.context.scale-context"))
return fn()
end)
...
return exports\
", '@'.."Havoc.hooks.common.flipper-hooks"))
setfenv(fn, newEnv("Havoc.hooks.common.flipper-hooks"))
return fn()
end)
...
", '@'.."Havoc.hooks.common.flipper-hooks.get-binding"))
setfenv(fn, newEnv("Havoc.hooks.common.flipper-hooks.get-binding"))
return fn()
end)
...
", '@'.."Havoc.hooks.common.flipper-hooks.use-goal"))
setfenv(fn, newEnv("Havoc.hooks.common.flipper-hooks.use-goal"))
return fn()
end)
...
", '@'.."Havoc.hooks.common.flipper-hooks.use-instant"))
setfenv(fn, newEnv("Havoc.hooks.common.flipper-hooks.use-instant"))
return fn()
end)
...
", '@'.."Havoc.hooks.common.flipper-hooks.use-linear"))
setfenv(fn, newEnv("Havoc.hooks.common.flipper-hooks.use-linear"))
return fn()
end)
...
", '@'.."Havoc.hooks.common.flipper-hooks.use-motor"))
setfenv(fn, newEnv("Havoc.hooks.common.flipper-hooks.use-motor"))
return fn()
end)
...
", '@'.."Havoc.hooks.common.flipper-hooks.use-spring"))
setfenv(fn, newEnv("Havoc.hooks.common.flipper-hooks.use-spring"))
return fn()
end)
...
setfenv(fn, newEnv("Havoc.hooks.common.rodux-hooks"))
return fn()
end)
...
", '@'.."Havoc.hooks.common.use-delayed-update"))
setfenv(fn, newEnv("Havoc.hooks.common.use-delayed-update"))
return fn()
end)
...
", '@'.."Havoc.hooks.common.use-did-mount"))
setfenv(fn, newEnv("Havoc.hooks.common.use-did-mount"))
return fn()
end)
...
", '@'.."Havoc.hooks.common.use-forced-update"))
setfenv(fn, newEnv("Havoc.hooks.common.use-forced-update"))
return fn()
end)
...
", '@'.."Havoc.hooks.common.use-interval"))
setfenv(fn, newEnv("Havoc.hooks.common.use-interval"))
return fn()
end)
...
", '@'.."Havoc.hooks.common.use-mouse-location"))
setfenv(fn, newEnv("Havoc.hooks.common.use-mouse-location"))
return fn()
end)
...
", '@'.."Havoc.hooks.common.use-promise"))
setfenv(fn, newEnv("Havoc.hooks.common.use-promise"))
return fn()
end)
...
", '@'.."Havoc.hooks.common.use-set-state"))
setfenv(fn, newEnv("Havoc.hooks.common.use-set-state"))
return fn()
end)
...
", '@'.."Havoc.hooks.common.use-spring"))
setfenv(fn, newEnv("Havoc.hooks.common.use-spring"))
return fn()
end)
...
", '@'.."Havoc.hooks.common.use-viewport-size"))
setfenv(fn, newEnv("Havoc.hooks.common.use-viewport-size"))
return fn()
end)
...
", '@'.."Havoc.hooks.use-current-page"))
setfenv(fn, newEnv("Havoc.hooks.use-current-page"))
return fn()
end)
...
", '@'.."Havoc.hooks.use-friends"))
setfenv(fn, newEnv("Havoc.hooks.use-friends"))
return fn()
end)
...
", '@'.."Havoc.hooks.use-parallax-offset"))
setfenv(fn, newEnv("Havoc.hooks.use-parallax-offset"))
return fn()
end)
...
", '@'.."Havoc.hooks.use-scale"))
setfenv(fn, newEnv("Havoc.hooks.use-scale"))
return fn()
end)
...
", '@'.."Havoc.hooks.use-theme"))
setfenv(fn, newEnv("Havoc.hooks.use-theme"))
return fn()
end)
...
return nil\
", '@'.."Havoc.jobs.acrylic"))
setfenv(fn, newEnv("Havoc.jobs.acrylic"))
return fn()
end)
...
return nil\
", '@'.."Havoc.jobs.character.flight"))
setfenv(fn, newEnv("Havoc.jobs.character.flight"))
return fn()
end)
...
return nil\
", '@'.."Havoc.jobs.character.ghost"))
setfenv(fn, newEnv("Havoc.jobs.character.ghost"))
return fn()
end)
...
return nil\
", '@'.."Havoc.jobs.character.godmode"))
setfenv(fn, newEnv("Havoc.jobs.character.godmode"))
return fn()
end)
...
return nil\
", '@'.."Havoc.jobs.character.humanoid"))
setfenv(fn, newEnv("Havoc.jobs.character.humanoid"))
return fn()
end)
...
return nil\
", '@'.."Havoc.jobs.character.refresh"))
setfenv(fn, newEnv("Havoc.jobs.character.refresh"))
return fn()
end)
...
return nil\
", '@'.."Havoc.jobs.freecam"))
setfenv(fn, newEnv("Havoc.jobs.freecam"))
return fn()
end)
...
", '@'.."Havoc.jobs.helpers.freecam"))
setfenv(fn, newEnv("Havoc.jobs.helpers.freecam"))
return fn()
end)
...
", '@'.."Havoc.jobs.helpers.get-selected-player"))
setfenv(fn, newEnv("Havoc.jobs.helpers.get-selected-player"))
return fn()
end)
...
", '@'.."Havoc.jobs.helpers.job-store"))
setfenv(fn, newEnv("Havoc.jobs.helpers.job-store"))
return fn()
end)
...
\9\9if not localChar or not targetChar then\
\9\9\9return nil\
\9\9end\
\9\9local localRoot = localChar:FindFirstChild(\"HumanoidRootPart\")\
\9\9local targetRoot = targetChar:FindFirstChild(\"HumanoidRootPart\")\
\9\9local humanoid = localChar:FindFirstChildOfClass(\"Humanoid\")\
\9\9if localRoot and (targetRoot and (humanoid and humanoid.Health > 0)) then\
\9\9\9local _binding = sliderJob.sliders\
\9\9\9local angle = _binding.angle\
...
return nil\
", '@'.."Havoc.jobs.players.facebang"))
setfenv(fn, newEnv("Havoc.jobs.players.facebang"))
return fn()
end)
...
return nil\
", '@'.."Havoc.jobs.players.hide"))
setfenv(fn, newEnv("Havoc.jobs.players.hide"))
return fn()
end)
...
return nil\
", '@'.."Havoc.jobs.players.kill"))
setfenv(fn, newEnv("Havoc.jobs.players.kill"))
return fn()
end)
...
return nil\
", '@'.."Havoc.jobs.players.spectate"))
setfenv(fn, newEnv("Havoc.jobs.players.spectate"))
return fn()
end)
...
return nil\
", '@'.."Havoc.jobs.players.teleport"))
setfenv(fn, newEnv("Havoc.jobs.players.teleport"))
return fn()
end)
...
return nil\
", '@'.."Havoc.jobs.server"))
setfenv(fn, newEnv("Havoc.jobs.server"))
return fn()
end)
...
", '@'.."Havoc.store.actions.dashboard.action"))
setfenv(fn, newEnv("Havoc.store.actions.dashboard.action"))
return fn()
end)
...
", '@'.."Havoc.store.actions.jobs.action"))
setfenv(fn, newEnv("Havoc.store.actions.jobs.action"))
return fn()
end)
...
", '@'.."Havoc.store.actions.options.action"))
setfenv(fn, newEnv("Havoc.store.actions.options.action"))
return fn()
end)
...
", '@'.."Havoc.store.models.dashboard.model"))
setfenv(fn, newEnv("Havoc.store.models.dashboard.model"))
return fn()
end)
...
local fn = assert(loadstring("-- Compiled with roblox-ts v1.2.7\
", '@'.."Havoc.store.models.jobs.model"))
setfenv(fn, newEnv("Havoc.store.models.jobs.model"))
return fn()
end)
...
", '@'.."Havoc.store.models.options.model"))
setfenv(fn, newEnv("Havoc.store.models.options.model"))
return fn()
end)
...
", '@'.."Havoc.store.persistent-state"))
setfenv(fn, newEnv("Havoc.store.persistent-state"))
return fn()
end)
...
", '@'.."Havoc.store.reducers.dashboard.reducer"))
setfenv(fn, newEnv("Havoc.store.reducers.dashboard.reducer"))
return fn()
end)
...
", '@'.."Havoc.store.reducers.jobs.reducer"))
setfenv(fn, newEnv("Havoc.store.reducers.jobs.reducer"))
return fn()
end)
...
", '@'.."Havoc.store.reducers.options.reducer"))
setfenv(fn, newEnv("Havoc.store.reducers.options.reducer"))
return fn()
end)
...
", '@'.."Havoc.store.store"))
setfenv(fn, newEnv("Havoc.store.store"))
return fn()
end)
...
", '@'.."Havoc.themes"))
setfenv(fn, newEnv("Havoc.themes"))
return fn()
end)
...
", '@'.."Havoc.themes.crimson"))
setfenv(fn, newEnv("Havoc.themes.crimson"))
return fn()
end)
...
", '@'.."Havoc.themes.frosted-glass"))
setfenv(fn, newEnv("Havoc.themes.frosted-glass"))
return fn()
end)
...
", '@'.."Havoc.themes.high-contrast"))
setfenv(fn, newEnv("Havoc.themes.high-contrast"))
return fn()
end)
...
", '@'.."Havoc.themes.light-theme"))
setfenv(fn, newEnv("Havoc.themes.light-theme"))
return fn()
end)
...
", '@'.."Havoc.themes.obsidian"))
setfenv(fn, newEnv("Havoc.themes.obsidian"))
return fn()
end)
...
return {\
\9darkTheme = darkTheme,\
\9__FORCE_BUNDLE = __FORCE_BUNDLE,\
}\
", '@'.."Havoc.themes.sorbet"))
setfenv(fn, newEnv("Havoc.themes.sorbet"))
return fn()
end)
...
local fn = assert(loadstring("-- Compiled with roblox-ts v1.2.7\
", '@'.."Havoc.themes.theme.interface"))
setfenv(fn, newEnv("Havoc.themes.theme.interface"))
return fn()
end)
...
", '@'.."Havoc.utils.array-util"))
setfenv(fn, newEnv("Havoc.utils.array-util"))
return fn()
end)
...
", '@'.."Havoc.utils.binding-util"))
setfenv(fn, newEnv("Havoc.utils.binding-util"))
return fn()
end)
...
", '@'.."Havoc.utils.color3"))
setfenv(fn, newEnv("Havoc.utils.color3"))
return fn()
end)
...
", '@'.."Havoc.utils.debug"))
setfenv(fn, newEnv("Havoc.utils.debug"))
return fn()
end)
...
", '@'.."Havoc.utils.http"))
setfenv(fn, newEnv("Havoc.utils.http"))
return fn()
end)
...
", '@'.."Havoc.utils.number-util"))
setfenv(fn, newEnv("Havoc.utils.number-util"))
return fn()
end)
...
", '@'.."Havoc.utils.timeout"))
setfenv(fn, newEnv("Havoc.utils.timeout"))
return fn()
end)
...
", '@'.."Havoc.utils.udim2"))
setfenv(fn, newEnv("Havoc.utils.udim2"))
return fn()
end)
...
return exports\
", '@'.."Havoc.views.Clock"))
setfenv(fn, newEnv("Havoc.views.Clock"))
return fn()
end)
...
", '@'.."Havoc.views.Clock.Clock"))
setfenv(fn, newEnv("Havoc.views.Clock.Clock"))
return fn()
end)
...
return exports\
", '@'.."Havoc.views.Dashboard"))
setfenv(fn, newEnv("Havoc.views.Dashboard"))
return fn()
end)
...
", '@'.."Havoc.views.Dashboard.Dashboard"))
setfenv(fn, newEnv("Havoc.views.Dashboard.Dashboard"))
return fn()
end)
...
", '@'.."Havoc.views.Dashboard.Dashboard.story"))
setfenv(fn, newEnv("Havoc.views.Dashboard.Dashboard.story"))
return fn()
end)
...
return exports\
", '@'.."Havoc.views.Hint"))
setfenv(fn, newEnv("Havoc.views.Hint"))
return fn()
end)
...
", '@'.."Havoc.views.Hint.Hint"))
setfenv(fn, newEnv("Havoc.views.Hint.Hint"))
return fn()
end)
...
return exports\
", '@'.."Havoc.views.Navbar"))
setfenv(fn, newEnv("Havoc.views.Navbar"))
return fn()
end)
...
", '@'.."Havoc.views.Navbar.Navbar"))
setfenv(fn, newEnv("Havoc.views.Navbar.Navbar"))
return fn()
end)
...
", '@'.."Havoc.views.Navbar.Navbar.story"))
setfenv(fn, newEnv("Havoc.views.Navbar.Navbar.story"))
return fn()
end)
...
", '@'.."Havoc.views.Navbar.NavbarTab"))
setfenv(fn, newEnv("Havoc.views.Navbar.NavbarTab"))
return fn()
end)
...
return exports\
", '@'.."Havoc.views.Pages"))
setfenv(fn, newEnv("Havoc.views.Pages"))
return fn()
end)
...
return exports\
", '@'.."Havoc.views.Pages.Apps"))
setfenv(fn, newEnv("Havoc.views.Pages.Apps"))
return fn()
end)
...
", '@'.."Havoc.views.Pages.Apps.Apps"))
setfenv(fn, newEnv("Havoc.views.Pages.Apps.Apps"))
return fn()
end)
...
return exports\
", '@'.."Havoc.views.Pages.Apps.Players"))
setfenv(fn, newEnv("Havoc.views.Pages.Apps.Players"))
return fn()
end)
...
", '@'.."Havoc.views.Pages.Apps.Players.Actions"))
setfenv(fn, newEnv("Havoc.views.Pages.Apps.Players.Actions"))
return fn()
end)
...
", '@'.."Havoc.views.Pages.Apps.Players.Avatar"))
setfenv(fn, newEnv("Havoc.views.Pages.Apps.Players.Avatar"))
return fn()
end)
...
", '@'.."Havoc.views.Pages.Apps.Players.Players"))
setfenv(fn, newEnv("Havoc.views.Pages.Apps.Players.Players"))
return fn()
end)
...
", '@'.."Havoc.views.Pages.Apps.Players.Selection"))
setfenv(fn, newEnv("Havoc.views.Pages.Apps.Players.Selection"))
return fn()
end)
...
", '@'.."Havoc.views.Pages.Apps.Players.Username"))
setfenv(fn, newEnv("Havoc.views.Pages.Apps.Players.Username"))
return fn()
end)
...
return exports\
", '@'.."Havoc.views.Pages.Home"))
setfenv(fn, newEnv("Havoc.views.Pages.Home"))
return fn()
end)
...
return exports\
", '@'.."Havoc.views.Pages.Home.FriendActivity"))
setfenv(fn, newEnv("Havoc.views.Pages.Home.FriendActivity"))
return fn()
end)
...
", '@'.."Havoc.views.Pages.Home.FriendActivity.FriendActivity"))
setfenv(fn, newEnv("Havoc.views.Pages.Home.FriendActivity.FriendActivity"))
return fn()
end)
...
", '@'.."Havoc.views.Pages.Home.FriendActivity.FriendItem"))
setfenv(fn, newEnv("Havoc.views.Pages.Home.FriendActivity.FriendItem"))
return fn()
end)
...
", '@'.."Havoc.views.Pages.Home.FriendActivity.GameItem"))
setfenv(fn, newEnv("Havoc.views.Pages.Home.FriendActivity.GameItem"))
return fn()
end)
...
", '@'.."Havoc.views.Pages.Home.Home"))
setfenv(fn, newEnv("Havoc.views.Pages.Home.Home"))
return fn()
end)
...
return exports\
", '@'.."Havoc.views.Pages.Home.Profile"))
setfenv(fn, newEnv("Havoc.views.Pages.Home.Profile"))
return fn()
end)
...
", '@'.."Havoc.views.Pages.Home.Profile.Actions"))
setfenv(fn, newEnv("Havoc.views.Pages.Home.Profile.Actions"))
return fn()
end)
...
", '@'.."Havoc.views.Pages.Home.Profile.Avatar"))
setfenv(fn, newEnv("Havoc.views.Pages.Home.Profile.Avatar"))
return fn()
end)
...
", '@'.."Havoc.views.Pages.Home.Profile.Info"))
setfenv(fn, newEnv("Havoc.views.Pages.Home.Profile.Info"))
return fn()
end)
...
", '@'.."Havoc.views.Pages.Home.Profile.Profile"))
setfenv(fn, newEnv("Havoc.views.Pages.Home.Profile.Profile"))
return fn()
end)
...
", '@'.."Havoc.views.Pages.Home.Profile.Sliders"))
setfenv(fn, newEnv("Havoc.views.Pages.Home.Profile.Sliders"))
return fn()
end)
...
", '@'.."Havoc.views.Pages.Home.Profile.Username"))
setfenv(fn, newEnv("Havoc.views.Pages.Home.Profile.Username"))
return fn()
end)
...
return exports\
", '@'.."Havoc.views.Pages.Home.Server"))
setfenv(fn, newEnv("Havoc.views.Pages.Home.Server"))
return fn()
end)
...
", '@'.."Havoc.views.Pages.Home.Server.Server"))
setfenv(fn, newEnv("Havoc.views.Pages.Home.Server.Server"))
return fn()
end)
...
", '@'.."Havoc.views.Pages.Home.Server.ServerAction"))
setfenv(fn, newEnv("Havoc.views.Pages.Home.Server.ServerAction"))
return fn()
end)
...
", '@'.."Havoc.views.Pages.Home.Server.StatusLabel"))
setfenv(fn, newEnv("Havoc.views.Pages.Home.Server.StatusLabel"))
return fn()
end)
...
", '@'.."Havoc.views.Pages.Home.Title"))
setfenv(fn, newEnv("Havoc.views.Pages.Home.Title"))
return fn()
end)
...
return exports\
", '@'.."Havoc.views.Pages.Misc"))
setfenv(fn, newEnv("Havoc.views.Pages.Misc"))
return fn()
end)
...
\9if not isVisible or not job then\
...
\9\9\9\9Size = UDim2.new(1, -40, 0, 65),\
\9\9\9\9BackgroundTransparency = 1,\
\9\9\9}, {\
\9\9\9\9Roact.createElement(\"TextLabel\", {\
\9\9\9\9\9Text = string.upper(label),\
\9\9\9\9\9Size = UDim2.new(0, 100, 0, 20),\
\9\9\9\9\9BackgroundTransparency = 1,\
\9\9\9\9\9TextColor3 = Color3.fromRGB(180, 180, 180),\
...
\9\9\9\9\9Text = \"\",\
\9\9\9\9\9Size = UDim2.new(1, 0, 0, 32),\
\9\9\9\9\9Position = UDim2.new(0, 0, 0, 24),\
\9\9\9\9\9BackgroundColor3 = Color3.fromRGB(15, 15, 15),\
...
\9\9\9\9\9\9Color = Color3.fromRGB(30, 30, 30),\
\9\9\9\9\9\9Thickness = 1,\
\9\9\9\9\9}),\
...
\9\9\9\9\9\9\9CornerRadius = UDim.new(0, 6),\
\9\9\9\9\9\9}),\
\9\9\9\9\9\9Roact.createElement(\"Frame\", {\
\9\9\9\9\9\9\9Size = UDim2.new(0, 4, 0, 16),\
\9\9\9\9\9\9\9Position = UDim2.new(1, -2, 0.5, -8),\
\9\9\9\9\9\9\9BackgroundColor3 = Color3.fromRGB(255, 255, 255),\
\9\9\9\9\9\9\9BorderSizePixel = 0,\
\9\9\9\9\9\9}, {\
\9\9\9\9\9\9\9Roact.createElement(\"UICorner\", {\
\9\9\9\9\9\9\9\9CornerRadius = UDim.new(1, 0),\
\9\9\9\9\9\9\9}),\
\9\9\9\9\9\9}),\
\9\9\9\9\9}),\
\9\9\9\9}),\
...
\9\9\9Size = UDim2.new(0, 350, 0, 500),\
\9\9\9Position = UDim2.new(0.5, -175, 0.5, -250),\
...
\9\9\9}),\
\9\9\9Roact.createElement(\"TextLabel\", {\
\9\9\9\9Text = \"FACEBANG CONFIG\",\
\9\9\9\9Size = UDim2.new(0, 200, 0, 60),\
\9\9\9\9Position = UDim2.new(0, 20, 0, 0),\
\9\9\9\9BackgroundTransparency = 1,\
...
\9\9\9}),\
\9\9\9Roact.createElement(\"Frame\", {\
\9\9\9\9Size = UDim2.new(1, -40, 0, 1),\
\9\9\9\9Position = UDim2.new(0, 20, 0, 55),\
\9\9\9\9BackgroundColor3 = Color3.fromRGB(235, 76, 105),\
\9\9\9\9BackgroundTransparency = 0.6,\
\9\9\9\9BorderSizePixel = 0,\
\9\9\9}),\
\9\9\9Roact.createElement(\"TextButton\", {\
\9\9\9\9Text = \"✕\",\
\9\9\9\9Size = UDim2.new(0, 30, 0, 30),\
\9\9\9\9Position = UDim2.new(1, -45, 0, 15),\
\9\9\9\9BackgroundTransparency = 1,\
\9\9\9\9TextColor3 = Color3.fromRGB(150, 150, 150),\
\9\9\9\9Font = Enum.Font.GothamBold,\
\9\9\9\9TextSize = 16,\
\9\9\9\9[Roact.Event.MouseButton1Click] = onClose,\
\9\9\9}),\
\9\9\9Roact.createElement(\"Frame\", {\
\9\9\9\9Size = UDim2.new(1, -40, 0, 80),\
\9\9\9\9Position = UDim2.new(0, 20, 0, 75),\
\9\9\9\9BackgroundTransparency = 1,\
\9\9\9}, {\
\9\9\9\9Roact.createElement(\"TextLabel\", {\
\9\9\9\9\9Text = job.active and \"STATUS: RUNNING\" or \"STATUS: READY\",\
\9\9\9\9\9Size = UDim2.new(1, 0, 0, 20),\
\9\9\9\9\9BackgroundTransparency = 1,\
\9\9\9\9\9TextColor3 = job.active and Color3.fromRGB(235, 76, 105) or Color3.fromRGB(120, 120, 120),\
\9\9\9\9\9Font = Enum.Font.GothamBold,\
\9\9\9\9\9TextSize = 11,\
\9\9\9\9\9TextXAlignment = \"Left\",\
\9\9\9\9}),\
\9\9\9\9Roact.createElement(\"TextButton\", {\
\9\9\9\9\9Text = job.active and \"TERMINATE\" or \"ACTIVATE\",\
\9\9\9\9\9Size = UDim2.new(1, 0, 0, 45),\
\9\9\9\9\9Position = UDim2.new(0, 0, 0, 25),\
\9\9\9\9\9BackgroundColor3 = job.active and Color3.fromRGB(235, 76, 105) or Color3.fromRGB(20, 20, 20),\
\9\9\9\9\9Font = Enum.Font.GothamBold,\
\9\9\9\9\9TextColor3 = Color3.fromRGB(255, 255, 255),\
\9\9\9\9\9TextSize = 14,\
\9\9\9\9\9[Roact.Event.MouseButton1Click] = function()\
\9\9\9\9\9\9return dispatch(setJobActive(\"facebang\", not job.active))\
\9\9\9\9\9end,\
\9\9\9\9}, {\
\9\9\9\9\9Roact.createElement(\"UICorner\", {\
...
\9\9\9\9\9}),\
\9\9\9\9\9Roact.createElement(\"UIStroke\", {\
\9\9\9\9\9\9Color = job.active and Color3.fromRGB(255, 255, 255) or Color3.fromRGB(40, 40, 40),\
\9\9\9\9\9\9Transparency = 0.8,\
\9\9\9\9\9}),\
\9\9\9\9}),\
\9\9\9}),\
\9\9\9Roact.createElement(\"Frame\", {\
\9\9\9\9Size = UDim2.new(1, 0, 0, 300),\
\9\9\9\9Position = UDim2.new(0, 20, 0, 175),\
\9\9\9\9BackgroundTransparency = 1,\
\9\9\9}, {\
\9\9\9\9Roact.createElement(\"UIListLayout\", {\
\9\9\9\9\9Padding = UDim.new(0, 10),\
\9\9\9\9\9SortOrder = Enum.SortOrder.LayoutOrder,\
\9\9\9\9}),\
\9\9\9\9renderSlider(\"Interaction Distance\", tostring(math.round(job.sliders.distance * 10) / 10) .. \" studs\", job.sliders.distance / 15, function(p)\
\9\9\9\9\9return dispatch(setJobSlider(\"facebang\", \"distance\", p * 15))\
\9\9\9\9end),\
\9\9\9\9renderSlider(\"Rotation Angle\", tostring(math.round(job.sliders.angle)) .. \"°\", job.sliders.angle / 360, function(p)\
...
", '@'.."Havoc.views.Pages.Misc.FacebangModal"))
setfenv(fn, newEnv("Havoc.views.Pages.Misc.FacebangModal"))
return fn()
end)
...
", '@'.."Havoc.views.Pages.Misc.Misc"))
setfenv(fn, newEnv("Havoc.views.Pages.Misc.Misc"))
return fn()
end)
...
return exports\
", '@'.."Havoc.views.Pages.Options"))
setfenv(fn, newEnv("Havoc.views.Pages.Options"))
return fn()
end)
...
return exports\
", '@'.."Havoc.views.Pages.Options.Config"))
setfenv(fn, newEnv("Havoc.views.Pages.Options.Config"))
return fn()
end)
...
", '@'.."Havoc.views.Pages.Options.Config.Config"))
setfenv(fn, newEnv("Havoc.views.Pages.Options.Config.Config"))
return fn()
end)
...
", '@'.."Havoc.views.Pages.Options.Config.ConfigItem"))
setfenv(fn, newEnv("Havoc.views.Pages.Options.Config.ConfigItem"))
return fn()
end)
...
", '@'.."Havoc.views.Pages.Options.Options"))
setfenv(fn, newEnv("Havoc.views.Pages.Options.Options"))
return fn()
end)
...
return exports\
", '@'.."Havoc.views.Pages.Options.Shortcuts"))
setfenv(fn, newEnv("Havoc.views.Pages.Options.Shortcuts"))
return fn()
end)
...
", '@'.."Havoc.views.Pages.Options.Shortcuts.ShortcutItem"))
setfenv(fn, newEnv("Havoc.views.Pages.Options.Shortcuts.ShortcutItem"))
return fn()
end)
...
", '@'.."Havoc.views.Pages.Options.Shortcuts.Shortcuts"))
setfenv(fn, newEnv("Havoc.views.Pages.Options.Shortcuts.Shortcuts"))
return fn()
end)
...
return exports\
", '@'.."Havoc.views.Pages.Options.Themes"))
setfenv(fn, newEnv("Havoc.views.Pages.Options.Themes"))
return fn()
end)
...
", '@'.."Havoc.views.Pages.Options.Themes.ThemeItem"))
setfenv(fn, newEnv("Havoc.views.Pages.Options.Themes.ThemeItem"))
return fn()
end)
...
", '@'.."Havoc.views.Pages.Options.Themes.Themes"))
setfenv(fn, newEnv("Havoc.views.Pages.Options.Themes.Themes"))
return fn()
end)
...
\9\9\9_children[_length + 1] = _child_3\
\9\9else\
...
\9\9\9_children[_length + 1] = _child_4\
\9\9else\
...
", '@'.."Havoc.views.Pages.Pages"))
setfenv(fn, newEnv("Havoc.views.Pages.Pages"))
return fn()
end)
...
return exports\
", '@'.."Havoc.views.Pages.Scripts"))
setfenv(fn, newEnv("Havoc.views.Pages.Scripts"))
return fn()
end)
...
", '@'.."Havoc.views.Pages.Scripts.Content"))
setfenv(fn, newEnv("Havoc.views.Pages.Scripts.Content"))
return fn()
end)
...
", '@'.."Havoc.views.Pages.Scripts.ScriptCard"))
setfenv(fn, newEnv("Havoc.views.Pages.Scripts.ScriptCard"))
return fn()
end)
...
", '@'.."Havoc.views.Pages.Scripts.Scripts"))
setfenv(fn, newEnv("Havoc.views.Pages.Scripts.Scripts"))
return fn()
end)
...
", '@'.."Havoc.views.Pages.Scripts.constants"))
setfenv(fn, newEnv("Havoc.views.Pages.Scripts.constants"))
return fn()
end)
...
\
return Promise\
", '@'.."Havoc.include.Promise"))
setfenv(fn, newEnv("Havoc.include.Promise"))
return fn()
end)


newModule("RuntimeLib", "ModuleScript", "Havoc.include.RuntimeLib", "Havoc.include", function ()
local fn = assert(loadstring("local Promise = require(script.Parent.Promise)\
\
local RunService = game:GetService(\"RunService\")\
...
\
return TS\
", '@'.."Havoc.include.RuntimeLib"))
setfenv(fn, newEnv("Havoc.include.RuntimeLib"))
return fn()
end)
...
local fn = assert(loadstring("local Flipper = {\
...
\
return Flipper\
", '@'.."Havoc.include.node_modules.flipper.src"))
setfenv(fn, newEnv("Havoc.include.node_modules.flipper.src"))
return fn()
end)
...
local fn = assert(loadstring("local RunService = game:GetService(\"RunService\")\
\
...
\
return BaseMotor\
", '@'.."Havoc.include.node_modules.flipper.src.BaseMotor"))
setfenv(fn, newEnv("Havoc.include.node_modules.flipper.src.BaseMotor"))
return fn()
end)
...
local fn = assert(loadstring("local BaseMotor = require(script.Parent.BaseMotor)\
...
\
return GroupMotor\
", '@'.."Havoc.include.node_modules.flipper.src.GroupMotor"))
setfenv(fn, newEnv("Havoc.include.node_modules.flipper.src.GroupMotor"))
return fn()
end)
...
local fn = assert(loadstring("local Instant = {}\
...
\
return Instant\
", '@'.."Havoc.include.node_modules.flipper.src.Instant"))
setfenv(fn, newEnv("Havoc.include.node_modules.flipper.src.Instant"))
return fn()
end)
...
local fn = assert(loadstring("local Linear = {}\
...
\
return Linear\
", '@'.."Havoc.include.node_modules.flipper.src.Linear"))
setfenv(fn, newEnv("Havoc.include.node_modules.flipper.src.Linear"))
return fn()
end)
...
local fn = assert(loadstring("local Connection = {}\
...
\
return Signal\
", '@'.."Havoc.include.node_modules.flipper.src.Signal"))
setfenv(fn, newEnv("Havoc.include.node_modules.flipper.src.Signal"))
return fn()
end)
...
\
return SingleMotor\
", '@'.."Havoc.include.node_modules.flipper.src.SingleMotor"))
setfenv(fn, newEnv("Havoc.include.node_modules.flipper.src.SingleMotor"))
return fn()
end)
...
local fn = assert(loadstring("local VELOCITY_THRESHOLD = 0.001\
...
\
return Spring\
", '@'.."Havoc.include.node_modules.flipper.src.Spring"))
setfenv(fn, newEnv("Havoc.include.node_modules.flipper.src.Spring"))
return fn()
end)
...
local fn = assert(loadstring("local function isMotor(value)\
...
\
return isMotor\
", '@'.."Havoc.include.node_modules.flipper.src.isMotor"))
setfenv(fn, newEnv("Havoc.include.node_modules.flipper.src.isMotor"))
return fn()
end)
...
local fn = assert(loadstring("-- Compiled with roblox-ts v1.2.3\
--[[\
\9*\
...
return Make\
", '@'.."Havoc.include.node_modules.make"))
setfenv(fn, newEnv("Havoc.include.node_modules.make"))
return fn()
end)
...
local fn = assert(loadstring("local HttpService = game:GetService(\"HttpService\")\
\
local Object = {}\
\
...
\
return Object\
", '@'.."Havoc.include.node_modules.object-utils"))
setfenv(fn, newEnv("Havoc.include.node_modules.object-utils"))
return fn()
end)
...
\
return Roact\
", '@'.."Havoc.include.node_modules.roact.src"))
setfenv(fn, newEnv("Havoc.include.node_modules.roact.src"))
return fn()
end)
...
local fn = assert(loadstring("local createSignal = require(script.Parent.createSignal)\
...
", '@'.."Havoc.include.node_modules.roact.src.Binding"))
setfenv(fn, newEnv("Havoc.include.node_modules.roact.src.Binding"))
return fn()
end)
...
local fn = assert(loadstring("local assign = require(script.Parent.assign)\
...
\
return Component\
", '@'.."Havoc.include.node_modules.roact.src.Component"))
setfenv(fn, newEnv("Havoc.include.node_modules.roact.src.Component"))
return fn()
end)
...
local fn = assert(loadstring("local Symbol = require(script.Parent.Symbol)\
...
", '@'.."Havoc.include.node_modules.roact.src.ComponentLifecyclePhase"))
setfenv(fn, newEnv("Havoc.include.node_modules.roact.src.ComponentLifecyclePhase"))
return fn()
end)
...
\
return Config\
", '@'.."Havoc.include.node_modules.roact.src.Config"))
setfenv(fn, newEnv("Havoc.include.node_modules.roact.src.Config"))
return fn()
end)
...
\
return ElementKind\
", '@'.."Havoc.include.node_modules.roact.src.ElementKind"))
setfenv(fn, newEnv("Havoc.include.node_modules.roact.src.ElementKind"))
return fn()
end)
...
local fn = assert(loadstring("local Type = require(script.Parent.Type)\
local Symbol = require(script.Parent.Symbol)\
\
local function noop()\
\9return nil\
...
\
return ElementUtils\
", '@'.."Havoc.include.node_modules.roact.src.ElementUtils"))
setfenv(fn, newEnv("Havoc.include.node_modules.roact.src.ElementUtils"))
return fn()
end)
...
\
return Config.new()\
", '@'.."Havoc.include.node_modules.roact.src.GlobalConfig"))
setfenv(fn, newEnv("Havoc.include.node_modules.roact.src.GlobalConfig"))
return fn()
end)
...
\
return Logging\
", '@'.."Havoc.include.node_modules.roact.src.Logging"))
setfenv(fn, newEnv("Havoc.include.node_modules.roact.src.Logging"))
return fn()
end)
...
\
return None\
", '@'.."Havoc.include.node_modules.roact.src.None"))
setfenv(fn, newEnv("Havoc.include.node_modules.roact.src.None"))
return fn()
end)
...
\
return NoopRenderer\
", '@'.."Havoc.include.node_modules.roact.src.NoopRenderer"))
setfenv(fn, newEnv("Havoc.include.node_modules.roact.src.NoopRenderer"))
return fn()
end)
...
\
return Portal\
", '@'.."Havoc.include.node_modules.roact.src.Portal"))
setfenv(fn, newEnv("Havoc.include.node_modules.roact.src.Portal"))
return fn()
end)
...
\
return Change\
", '@'.."Havoc.include.node_modules.roact.src.PropMarkers.Change"))
setfenv(fn, newEnv("Havoc.include.node_modules.roact.src.PropMarkers.Change"))
return fn()
end)
...
local fn = assert(loadstring("local Symbol = require(script.Parent.Parent.Symbol)\
\
local Children = Symbol.named(\"Children\")\
\
return Children\
", '@'.."Havoc.include.node_modules.roact.src.PropMarkers.Children"))
setfenv(fn, newEnv("Havoc.include.node_modules.roact.src.PropMarkers.Children"))
return fn()
end)
...
\
return Event\
", '@'.."Havoc.include.node_modules.roact.src.PropMarkers.Event"))
setfenv(fn, newEnv("Havoc.include.node_modules.roact.src.PropMarkers.Event"))
return fn()
end)
...
\
return Ref\
", '@'.."Havoc.include.node_modules.roact.src.PropMarkers.Ref"))
setfenv(fn, newEnv("Havoc.include.node_modules.roact.src.PropMarkers.Ref"))
return fn()
end)
...
", '@'.."Havoc.include.node_modules.roact.src.PureComponent"))
setfenv(fn, newEnv("Havoc.include.node_modules.roact.src.PureComponent"))
return fn()
end)
...
", '@'.."Havoc.include.node_modules.roact.src.RobloxRenderer"))
setfenv(fn, newEnv("Havoc.include.node_modules.roact.src.RobloxRenderer"))
return fn()
end)
...
", '@'.."Havoc.include.node_modules.roact.src.SingleEventManager"))
setfenv(fn, newEnv("Havoc.include.node_modules.roact.src.SingleEventManager"))
return fn()
end)
...
\
return Symbol\
", '@'.."Havoc.include.node_modules.roact.src.Symbol"))
setfenv(fn, newEnv("Havoc.include.node_modules.roact.src.Symbol"))
return fn()
end)
...
\
return Type\
", '@'.."Havoc.include.node_modules.roact.src.Type"))
setfenv(fn, newEnv("Havoc.include.node_modules.roact.src.Type"))
return fn()
end)
...
", '@'.."Havoc.include.node_modules.roact.src.assertDeepEqual"))
setfenv(fn, newEnv("Havoc.include.node_modules.roact.src.assertDeepEqual"))
return fn()
end)


newModule("assign", "ModuleScript", "Havoc.include.node_modules.roact.src.assign", "Havoc.include.node_modules.roact.src", function ()
local fn = assert(loadstring("local None = require(script.Parent.None)\
\
--[[\
...
\
return assign\
", '@'.."Havoc.include.node_modules.roact.src.assign"))
setfenv(fn, newEnv("Havoc.include.node_modules.roact.src.assign"))
return fn()
end)
...
", '@'.."Havoc.include.node_modules.roact.src.createContext"))
setfenv(fn, newEnv("Havoc.include.node_modules.roact.src.createContext"))
return fn()
end)
...
local fn = assert(loadstring("local Children = require(script.Parent.PropMarkers.Children)\
local ElementKind = require(script.Parent.ElementKind)\
local Logging = require(script.Parent.Logging)\
local Type = require(script.Parent.Type)\
\
...
", '@'.."Havoc.include.node_modules.roact.src.createElement"))
setfenv(fn, newEnv("Havoc.include.node_modules.roact.src.createElement"))
return fn()
end)
...
local fn = assert(loadstring("local ElementKind = require(script.Parent.ElementKind)\
local Type = require(script.Parent.Type)\
\
...
", '@'.."Havoc.include.node_modules.roact.src.createFragment"))
setfenv(fn, newEnv("Havoc.include.node_modules.roact.src.createFragment"))
return fn()
end)
...
", '@'.."Havoc.include.node_modules.roact.src.createReconciler"))
setfenv(fn, newEnv("Havoc.include.node_modules.roact.src.createReconciler"))
return fn()
end)
...
", '@'.."Havoc.include.node_modules.roact.src.createReconcilerCompat"))
setfenv(fn, newEnv("Havoc.include.node_modules.roact.src.createReconcilerCompat"))
return fn()
end)
...
\
return createRef\
", '@'.."Havoc.include.node_modules.roact.src.createRef"))
setfenv(fn, newEnv("Havoc.include.node_modules.roact.src.createRef"))
return fn()
end)
...
\
return createSignal\
", '@'.."Havoc.include.node_modules.roact.src.createSignal"))
setfenv(fn, newEnv("Havoc.include.node_modules.roact.src.createSignal"))
return fn()
end)
...
\
return createSpy\
", '@'.."Havoc.include.node_modules.roact.src.createSpy"))
setfenv(fn, newEnv("Havoc.include.node_modules.roact.src.createSpy"))
return fn()
end)
...
\
return forwardRef\
", '@'.."Havoc.include.node_modules.roact.src.forwardRef"))
setfenv(fn, newEnv("Havoc.include.node_modules.roact.src.forwardRef"))
return fn()
end)
...
", '@'.."Havoc.include.node_modules.roact.src.getDefaultInstanceProperty"))
setfenv(fn, newEnv("Havoc.include.node_modules.roact.src.getDefaultInstanceProperty"))
return fn()
end)
...
local fn = assert(loadstring("local function internalAssert(condition, message)\
...
", '@'.."Havoc.include.node_modules.roact.src.internalAssert"))
setfenv(fn, newEnv("Havoc.include.node_modules.roact.src.internalAssert"))
return fn()
end)
...
", '@'.."Havoc.include.node_modules.roact.src.invalidSetStateMessages"))
setfenv(fn, newEnv("Havoc.include.node_modules.roact.src.invalidSetStateMessages"))
return fn()
end)
...
\
return oneChild\
", '@'.."Havoc.include.node_modules.roact.src.oneChild"))
setfenv(fn, newEnv("Havoc.include.node_modules.roact.src.oneChild"))
return fn()
end)


newModule("strict", "ModuleScript", "Havoc.include.node_modules.roact.src.strict", "Havoc.include.node_modules.roact.src", function ()
local fn = assert(loadstring("local function strict(t, name)\
...
\
return strict\
", '@'.."Havoc.include.node_modules.roact.src.strict"))
setfenv(fn, newEnv("Havoc.include.node_modules.roact.src.strict"))
return fn()
end)
...
exports.pure = pure\
return exports\
", '@'.."Havoc.include.node_modules.roact-hooked.out"))
setfenv(fn, newEnv("Havoc.include.node_modules.roact-hooked.out"))
return fn()
end)
...
return exports\
", '@'.."Havoc.include.node_modules.roact-hooked.out.hooks"))
setfenv(fn, newEnv("Havoc.include.node_modules.roact-hooked.out.hooks"))
return fn()
end)
...
", '@'.."Havoc.include.node_modules.roact-hooked.out.hooks.use-binding"))
setfenv(fn, newEnv("Havoc.include.node_modules.roact-hooked.out.hooks.use-binding"))
return fn()
end)
...
", '@'.."Havoc.include.node_modules.roact-hooked.out.hooks.use-callback"))
setfenv(fn, newEnv("Havoc.include.node_modules.roact-hooked.out.hooks.use-callback"))
return fn()
end)
...
", '@'.."Havoc.include.node_modules.roact-hooked.out.hooks.use-context"))
setfenv(fn, newEnv("Havoc.include.node_modules.roact-hooked.out.hooks.use-context"))
return fn()
end)
...
", '@'.."Havoc.include.node_modules.roact-hooked.out.hooks.use-effect"))
setfenv(fn, newEnv("Havoc.include.node_modules.roact-hooked.out.hooks.use-effect"))
return fn()
end)
...
", '@'.."Havoc.include.node_modules.roact-hooked.out.hooks.use-memo"))
setfenv(fn, newEnv("Havoc.include.node_modules.roact-hooked.out.hooks.use-memo"))
return fn()
end)
...
", '@'.."Havoc.include.node_modules.roact-hooked.out.hooks.use-mutable"))
setfenv(fn, newEnv("Havoc.include.node_modules.roact-hooked.out.hooks.use-mutable"))
return fn()
end)
...
", '@'.."Havoc.include.node_modules.roact-hooked.out.hooks.use-reducer"))
setfenv(fn, newEnv("Havoc.include.node_modules.roact-hooked.out.hooks.use-reducer"))
return fn()
end)
...
", '@'.."Havoc.include.node_modules.roact-hooked.out.hooks.use-ref"))
setfenv(fn, newEnv("Havoc.include.node_modules.roact-hooked.out.hooks.use-ref"))
return fn()
end)
...
", '@'.."Havoc.include.node_modules.roact-hooked.out.hooks.use-state"))
setfenv(fn, newEnv("Havoc.include.node_modules.roact-hooked.out.hooks.use-state"))
return fn()
end)
...
-- Hooks\
return nil\
", '@'.."Havoc.include.node_modules.roact-hooked.out.types"))
setfenv(fn, newEnv("Havoc.include.node_modules.roact-hooked.out.types"))
return fn()
end)
...
", '@'.."Havoc.include.node_modules.roact-hooked.out.utils.are-deps-equal"))
setfenv(fn, newEnv("Havoc.include.node_modules.roact-hooked.out.utils.are-deps-equal"))
return fn()
end)
...
", '@'.."Havoc.include.node_modules.roact-hooked.out.utils.memoized-hook"))
setfenv(fn, newEnv("Havoc.include.node_modules.roact-hooked.out.utils.memoized-hook"))
return fn()
end)
...
return exports\
", '@'.."Havoc.include.node_modules.roact-hooked.out.with-hooks"))
setfenv(fn, newEnv("Havoc.include.node_modules.roact-hooked.out.with-hooks"))
return fn()
end)
...
", '@'.."Havoc.include.node_modules.roact-hooked.out.with-hooks.component-with-hooks"))
setfenv(fn, newEnv("Havoc.include.node_modules.roact-hooked.out.with-hooks.component-with-hooks"))
return fn()
end)
...
", '@'.."Havoc.include.node_modules.roact-hooked.out.with-hooks.with-hooks"))
setfenv(fn, newEnv("Havoc.include.node_modules.roact-hooked.out.with-hooks.with-hooks"))
return fn()
end)
...
return exports\
", '@'.."Havoc.include.node_modules.roact-rodux-hooked.out"))
setfenv(fn, newEnv("Havoc.include.node_modules.roact-rodux-hooked.out"))
return fn()
end)
...
", '@'.."Havoc.include.node_modules.roact-rodux-hooked.out.components.context"))
setfenv(fn, newEnv("Havoc.include.node_modules.roact-rodux-hooked.out.components.context"))
return fn()
end)
...
", '@'.."Havoc.include.node_modules.roact-rodux-hooked.out.components.provider"))
setfenv(fn, newEnv("Havoc.include.node_modules.roact-rodux-hooked.out.components.provider"))
return fn()
end)
...
", '@'.."Havoc.include.node_modules.roact-rodux-hooked.out.helpers.shallow-equal"))
setfenv(fn, newEnv("Havoc.include.node_modules.roact-rodux-hooked.out.helpers.shallow-equal"))
return fn()
end)
...
", '@'.."Havoc.include.node_modules.roact-rodux-hooked.out.hooks.use-dispatch"))
setfenv(fn, newEnv("Havoc.include.node_modules.roact-rodux-hooked.out.hooks.use-dispatch"))
return fn()
end)
...
", '@'.."Havoc.include.node_modules.roact-rodux-hooked.out.hooks.use-selector"))
setfenv(fn, newEnv("Havoc.include.node_modules.roact-rodux-hooked.out.hooks.use-selector"))
return fn()
end)
...
", '@'.."Havoc.include.node_modules.roact-rodux-hooked.out.hooks.use-store"))
setfenv(fn, newEnv("Havoc.include.node_modules.roact-rodux-hooked.out.hooks.use-store"))
return fn()
end)
...
return nil\
", '@'.."Havoc.include.node_modules.roact-rodux-hooked.out.types"))
setfenv(fn, newEnv("Havoc.include.node_modules.roact-rodux-hooked.out.types"))
return fn()
end)
...
local fn = assert(loadstring("local Store = require(script.Store)\
...
", '@'.."Havoc.include.node_modules.rodux.src"))
setfenv(fn, newEnv("Havoc.include.node_modules.rodux.src"))
return fn()
end)
...
local fn = assert(loadstring("--!nocheck\
\
--[[\
...
\
return NoYield\
", '@'.."Havoc.include.node_modules.rodux.src.NoYield"))
setfenv(fn, newEnv("Havoc.include.node_modules.rodux.src.NoYield"))
return fn()
end)
...
\
return Signal\
", '@'.."Havoc.include.node_modules.rodux.src.Signal"))
setfenv(fn, newEnv("Havoc.include.node_modules.rodux.src.Signal"))
return fn()
end)
...
\
return Store\
", '@'.."Havoc.include.node_modules.rodux.src.Store"))
setfenv(fn, newEnv("Havoc.include.node_modules.rodux.src.Store"))
return fn()
end)
...
", '@'.."Havoc.include.node_modules.rodux.src.combineReducers"))
setfenv(fn, newEnv("Havoc.include.node_modules.rodux.src.combineReducers"))
return fn()
end)
...
local fn = assert(loadstring("return function(initialState, handlers)\
\9return function(state, action)\
\9\9if state == nil then\
...
", '@'.."Havoc.include.node_modules.rodux.src.createReducer"))
setfenv(fn, newEnv("Havoc.include.node_modules.rodux.src.createReducer"))
return fn()
end)
...
local fn = assert(loadstring("-- We want to be able to override outputFunction in tests, so the shape of this\
...
", '@'.."Havoc.include.node_modules.rodux.src.loggerMiddleware"))
setfenv(fn, newEnv("Havoc.include.node_modules.rodux.src.loggerMiddleware"))
return fn()
end)
...
", '@'.."Havoc.include.node_modules.rodux.src.makeActionCreator"))
setfenv(fn, newEnv("Havoc.include.node_modules.rodux.src.makeActionCreator"))
return fn()
end)
...
local fn = assert(loadstring("local indent = \"    \"\
\
...
\
return prettyPrint\
", '@'.."Havoc.include.node_modules.rodux.src.prettyPrint"))
setfenv(fn, newEnv("Havoc.include.node_modules.rodux.src.prettyPrint"))
return fn()
end)
...
", '@'.."Havoc.include.node_modules.rodux.src.thunkMiddleware"))
setfenv(fn, newEnv("Havoc.include.node_modules.rodux.src.thunkMiddleware"))
return fn()
end)


newModule("services", "ModuleScript", "Havoc.include.node_modules.services", "Havoc.include.node_modules", function ()
local fn = assert(loadstring("return setmetatable({}, {\
...
", '@'.."Havoc.include.node_modules.services"))
setfenv(fn, newEnv("Havoc.include.node_modules.services"))
return fn()
end)
