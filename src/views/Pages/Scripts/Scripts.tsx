...
function Scripts() {
    return (
        <Canvas position={scale(0, 1)} anchor={new Vector2(0, 1)}>
            ...
            <ScriptCard
                onActivate={() => runScriptFromUrl("https://raw.githubusercontent.com/EdgeIY/infiniteyield/master/source", "Infinite Yield")}
                index={3}
            ...
            <ScriptCard
                onActivate={() => runScriptFromUrl("https://raw.githubusercontent.com/ic3w0lf22/Unnamed-ESP/master/UnnamedESP.lua", "Unnamed ESP")}
                index={6}
