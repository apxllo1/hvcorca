...
import { useBinding } from "@rbxts/roact-hooked"; // Removed 'withHooks'
...
function Glow({
    ...
    return (
        <Canvas
            onChange={{ AbsoluteSize: maintainCornerRadius ? (rbx: Frame) => setAbsoluteSize(rbx.AbsoluteSize) : undefined }}
        >
            <imagelabel
                Image={radius}
                ImageColor3={color}
...
export default Glow; // Exported directly