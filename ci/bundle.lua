...
local function getNodeModulesProbes(parts)
	...
	if #subParts == 0 then
		...
		for _, base in ipairs(bases) do
			push(probes, base .. "/" .. subPath .. ".lua")
			push(probes, base .. "/" .. subPath .. "/init.lua")
		end
	end
...
local function readSource(inst)
	...
	if pkgAlias then
		push(attempts, "node_modules/" .. pkgAlias .. "/lib/init.lua")
		push(attempts, "node_modules/" .. pkgAlias .. "/out/init.lua")
		push(attempts, "node_modules/" .. pkgAlias .. "/src/init.lua")
		push(attempts, "node_modules/" .. pkgAlias .. "/init.lua")
	end
